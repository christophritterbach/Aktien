...
import de.ritterbach.jameica.aktien.gui.action.KaufNewAction;
...
public class KaufMenu extends ContextMenu {
	public KaufMenu(Aktie aktie) {
		...
		addItem(new ContextMenuItem(Settings.i18n().tr("New..."),new Action()
		{
			...
			{
				new KaufNewAction().handleAction(aktie);
			}
		}));
