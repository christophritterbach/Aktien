...
public class DBSupportPostgreSQLImpl extends AbstractDBSupportImpl
{
  ...
  {
    return AktienDBService.SETTINGS.getString("database.driver.postgresql.jdbcdriver","org.postgresql.Driver");
  }
  ...
  {
    return AktienDBService.SETTINGS.getString("database.driver.postgresql.jdbcurl","jdbc:postgresql://localhost:5432/hibiscus");
  }
  ...
  {
    return AktienDBService.SETTINGS.getString("database.driver.postgresql.username","hibiscus");
  }
