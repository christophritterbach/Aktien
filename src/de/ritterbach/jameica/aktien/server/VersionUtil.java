...
public class VersionUtil
{
   ...
   */
  public static Version getVersion(AktienDBService service, String name) throws RemoteException, ApplicationException
  {
   ...
   * @throws RemoteException
   */
  public static int deleteAll(AktienDBService service, String prefix) throws RemoteException
  {
   ...
   * @throws RemoteException
   */
  public static int delete(AktienDBService service, String name) throws RemoteException
  {
    if (name == null || name.length() == 0)
