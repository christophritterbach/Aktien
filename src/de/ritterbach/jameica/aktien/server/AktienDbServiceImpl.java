...
import de.ritterbach.jameica.aktien.rmi.DBSupport;
import de.ritterbach.jameica.aktien.rmi.Version;
...
public class AktienDbServiceImpl extends DBServiceImpl implements AktienDBService {
	private DBSupport driver = null;

	/**
	 * @throws RemoteException
	 */
	public AktienDbServiceImpl() throws RemoteException {
	 ...
	 * @throws RemoteException
	 */
	public AktienDbServiceImpl(String driverClass) throws RemoteException {
		super();
		BeanService service = Application.getBootLoader().getBootable(BeanService.class);
		MultipleClassLoader cl = Application.getPluginLoader().getManifest(AktienPlugin.class).getClassLoader();
	...
	public String getName() throws RemoteException {
		...
		return i18n.tr("Datenbank-Service fuer Aktien");
	}
	...
	public void checkConsistency() throws RemoteException, ApplicationException {
		...
		try {
			...
			UpdateProvider provider = new AktienUpdateProvider(getConnection(), version);
	...
	public void install() throws RemoteException {
		...
		monitor.setStatusText(i18n.tr("Installiere Aktien"));

		Manifest mf = Application.getPluginLoader().getPlugin(AktienPlugin.class).getManifest();
