...
public class DBSupportMySqlImpl extends AbstractDBSupportImpl
{
  ...
  {
    return AktienDBService.SETTINGS.getString("database.driver.mysql.jdbcdriver",DRIVER);
  }
  ...
  {
    return AktienDBService.SETTINGS.getString("database.driver.mysql.jdbcurl","jdbc:mariadb://localhost:3306/aktien?useUnicode=Yes&characterEncoding=ISO8859_1&serverTimezone=Europe/Paris");
  }
  ...
  {
    return AktienDBService.SETTINGS.getString("database.driver.mysql.username","aktien");
  }
