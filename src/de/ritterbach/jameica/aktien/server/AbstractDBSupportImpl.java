...
public abstract class AbstractDBSupportImpl implements DBSupport {
	...
	String getEncrypted(String key) {
		String value = AktienDBService.SETTINGS.getString(key, null);
		...
		boolean doEncrypt = AktienDBService.SETTINGS.getBoolean("encrypt", false);
		...
		try {
			...
			AktienDBService.SETTINGS.setAttribute(key, PREFIX_ENC + Base64.encode(bos.toByteArray()));
